          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div>
              ...
              >
                ...
                <option value="deepseek-chat">💬 DeepSeek V3 Chat (ประหยัดสุด / แปลพร้อมกัน 5 หน้า)</option>
                <option value="deepseek-v4-flash">🚀 DeepSeek V4 Flash (เร็ว & งานดีกว่า / แปลพร้อมกัน 5 หน้า)</option>
